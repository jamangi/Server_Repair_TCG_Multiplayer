...
export function openSettingsDialog(context) {
  ...
  dialog.innerHTML = `
    ...
    <header><p class="play-eyebrow">Solo Pages v1</p><h2 id="settings-heading">Settings &amp; local data</h2><p>Presentation choices do not change engine legality or frozen gameplay.</p></header>
