...
- the complete canonical campaign-one story, *The Quiet Cascade*: four chapters, six solvability-proved real Matches covering all twelve current causal fingerprints, 324 reachable statements, 48 route/outcome traversals, three ending bands, and exact replayable Builder/engine reports;
...
TASK-033 is the next active contract in a four-task Story characterization sequence. It first audits every campaign line for the workflow context an intelligent new employee needs; TASK-034 builds a context-complete candidate dialogue layer; TASK-035 deepens the nine canonical character bibles and voice rules; and TASK-036 performs one versioned production revoice after both meaning and personality are reviewable. This order avoids two live campaign migrations and prevents characterization from erasing technical context. The owner pre-approved continuity-safe backstory and transformed public-domain reference choices through [`STORY-008 A`](docs/design/decisions/APPROVALS.md#story-008--characterization-pass-creative-discretion--a-approved-2026-08-28). See the [task index](docs/tasks/INDEX.md).
