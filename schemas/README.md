...
| [`system_model_catalog.schema.json`](domain/system_model_catalog.schema.json) | A strict source-backed System Model profile catalog: identity/exactness, options, eight planes, Component roles, topology, lifecycle, observation/control surfaces, Finder capabilities, explanatory action attachments, templates, provenance, and canonical digests. |
| [`ticket_system_binding_catalog.schema.json`](domain/ticket_system_binding_catalog.schema.json) | Public-only Ticket-to-profile resolver keys, immutable Ticket/profile pins, public requirements, and complete public-Candidate closure. |
| [`system_model_private_validation_catalog.schema.json`](domain/system_model_private_validation_catalog.schema.json) | Build/server-only hidden authoring compatibility proofs and differential non-leak vectors, stored separately from public bindings. |
| [`system_model_relationship_overlay.schema.json`](domain/system_model_relationship_overlay.schema.json) | Sourced profile-scoped domain/action relationship enrichment without mutating released domain objects or creating a second Component ontology. |
| [`system_model_migration.schema.json`](domain/system_model_migration.schema.json) | The immutable successor-overlay migration, exact Ticket snapshot pins, added/preserved Component IDs, and unchanged-authority declarations. |
| [`system_model_release_manifest.schema.json`](domain/system_model_release_manifest.schema.json) | Deterministic generator, schema, output, immutable-input, and denominator hashes for one System Model release. |
| [`system_model_public_projection.schema.json`](domain/system_model_public_projection.schema.json) | One player-safe, byte-stable derived System Model projection containing lifecycle, accessible topology, inventory, Candidate closure, and system-relevance graphs. |
| [`system_model_resolver_fixture_catalog.schema.json`](domain/system_model_resolver_fixture_catalog.schema.json) | The bounded TASK-052 invalid-profile mutation catalog and expected stable public failure codes. |
| [`system_model_resolver_proof.schema.json`](domain/system_model_resolver_proof.schema.json) | Aggregate five-Ticket resolver evidence, including deterministic resolutions, reject-only authoring summaries, differential counts, invalid results, and unchanged-gameplay declarations. |
| [`system_model_resolver_result.schema.json`](domain/system_model_resolver_result.schema.json) | The discriminated resolved/unavailable API result, including selected public binding pins, trace, strict projection, or bounded honest fallback. |
...
- [`content/system-model-pilot-v1/`](../content/system-model-pilot-v1/) is a separate explanatory domain overlay. Public Ticket bindings and private compatibility proofs are distinct artifacts; neither changes Card legality, Evidence, Isolation, Repair, Verify, or Story behavior.
