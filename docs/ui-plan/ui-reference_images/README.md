...
## 12 — System Model host/BMC concept

![System Model host and BMC concept](./system-model-host-bmc-concept.png)

This project-owner-supplied schematic introduces a useful explanatory hierarchy: one server motherboard can contain a host-compute region and a separately initialized management/BMC region with different processors, memory, firmware, and responsibilities. TASK-049 uses it to define model and information boundaries; TASK-050 uses it as a minimal diagram concept while researching richer five-Ticket topologies; TASK-055 may use its clarity as a UI reference.

It is not a complete server architecture, a universally correct boot order, a real product specification, an authoritative Component inventory, or permission to reveal a Ticket's hidden faulty component. Production diagrams must be derived from source-backed structured System Models, preserve all public Candidates, distinguish topology/flow types without color alone, and provide a complete text equivalent.
...
- System Model concept provenance: one project-owner-supplied 2026-08-30 schematic, SHA-256 `52C2665CA7F23145FA19A9F761F512A77678F152DDE18A1214F504DC65BFEF55`. It is a planning reference for subsystem grouping and diagram clarity, not production art or technical authority.
