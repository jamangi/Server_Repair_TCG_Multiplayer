...
- [`TASK-018-HIGH: Fix Play dialog lifecycle and Ticket-visibility regressions`](TASK-018-fix-play-dialog-and-ticket-visibility-regressions.md) — active corrective task; fixes repeat animated modal use, clipped Global Ticket content, and Ticket symptom contrast with child-level browser assertions and no gameplay changes.
...
TASK-012-HIGH through TASK-014-XHIGH and TASK-016-HIGH are complete. Post-completion playtesting established corrective order TASK-018-HIGH → TASK-019-HIGH → TASK-015-HIGH. TASK-011-HIGH may proceed where asset integration permits. Return to TASK-017-XHIGH only when the project owner reactivates V2 migration.
